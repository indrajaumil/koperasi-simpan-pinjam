...
/**
 * This is the model class for table "q_anggota_tipe_cabang".
 *
 * The followings are the available columns in table 'q_anggota_tipe_cabang':
 * @property string $No_BA
 * @property string $Kelompok
 * @property string $Nama_Sub_Unit_Kelompok
 ...
 * @property string $SP_Kurang_Lebih
 * @property string $SW_Kurang_Lebih
 * @property string $DS_Kurang_Lebih
 ...
 */
class QAnggotaTipeCabang extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return QAnggotaTipeCabang the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('Nama_Sub_Unit_Kelompok, Nama_Cabang, Jenis_Keanggotaan, Tgl_Masuk, Nama, Jns_Kelamin, Agama, Pendidikan_Terakhir, Created_By, Created_DateTime, Last_Update_By, Last_Update_DateTime, Created_Location, Last_Update_Location', 'required'),
			array('Jns_Kelamin, Agama, Status_Perkawinan, Pendidikan_Terakhir, Status_Orientasi, Kategori_Anggota, Status_Keanggotaan, Kategori_Keluar, Status_Sisa_Kewajiban', 'numerical', 'integerOnly'=>true),
			array('AA_Print_Line', 'numerical'),
			array('No_BA, No_BA_Referensi, No, RT, RW, Kode_Pos, No_Tinggal, RT_Tinggal, RW_Tinggal, Kode_Pos_Tinggal', 'length', 'max'=>10),
			array('Kelompok, Created_Location, Last_Update_Location', 'length', 'max'=>5),
			array('Nama_Sub_Unit_Kelompok', 'length', 'max'=>75),
			array('Kode_Cabang, Kode_Jenis', 'length', 'max'=>2),
			array('Nama_Cabang, SP_Kurang_Lebih, SW_Kurang_Lebih, DS_Kurang_Lebih', 'length', 'max'=>20),
			array('Jenis_Keanggotaan, Created_By, Last_Update_By', 'length', 'max'=>30),
			array('Referensi, No_ID, Nama, Tempat_Lahir, Kelurahan, Kecamatan, Kota, No_Telp, No_HP, Email, Kelurahan_Tinggal, Kecamatan_Tinggal, Kota_Tinggal, Instansi', 'length', 'max'=>100),
			...
			array('Sisa_Kewajiban, AA_Saldo_UP, AA_Saldo_SP, AA_Saldo_SW, AA_Saldo_SS, AA_Saldo_DS, AA_Saldo_SP_Seharusnya, AA_Saldo_SW_Seharusnya, AA_Saldo_DS_Seharusnya, Besar_Pembagi_Saham', 'length', 'max'=>19),
			array('Tgl_Lahir, Tgl_Lahir_Ahli_Waris1, Tgl_Lahir_Ahli_Waris2, Tgl_Lahir_Ahli_Waris3, Tgl_Lahir_Ahli_Waris4, Catatan_Khusus, Tgl_Orientasi, Tgl_Keluar, Tgl_Bayar_Sisa_Kewajiban, AA_Tgl_Transaksi_AA_Terakhir, AA_Tgl_Transaksi_DS_Terakhir, Foto', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('No_BA, Kelompok, Nama_Sub_Unit_Kelompok, Kode_Cabang, Nama_Cabang, Kode_Jenis, Jenis_Keanggotaan, Tgl_Masuk, No_BA_Referensi, Referensi, No_ID, Nama, Jns_Kelamin, Tempat_Lahir, Tgl_Lahir, Agama, Status_Perkawinan, Alamat, No, RT, RW, Kelurahan, Kecamatan, Kota, Kode_Pos, No_Telp, No_HP, Email, Alamat_Tinggal, No_Tinggal, RT_Tinggal, RW_Tinggal, Kelurahan_Tinggal, Kecamatan_Tinggal, Kota_Tinggal, Kode_Pos_Tinggal, Pendidikan_Terakhir, Pekerjaan, Instansi, Alamat_Instansi, No_Telp_Instansi, Nama_Ahli_Waris1, Nama_Ahli_Waris2, Nama_Ahli_Waris3, Nama_Ahli_Waris4, Hubungan_Ahli_Waris1, Hubungan_Ahli_Waris2, Hubungan_Ahli_Waris3, Hubungan_Ahli_Waris4, Tempat_Lahir_Ahli_Waris1, Tempat_Lahir_Ahli_Waris2, Tempat_Lahir_Ahli_Waris3, Tempat_Lahir_Ahli_Waris4, Tgl_Lahir_Ahli_Waris1, Tgl_Lahir_Ahli_Waris2, Tgl_Lahir_Ahli_Waris3, Tgl_Lahir_Ahli_Waris4, Catatan_Khusus, Status_Orientasi, Tgl_Orientasi, Kategori_Anggota, Status_Keanggotaan, Kategori_Keluar, Tgl_Keluar, Alasan_Keluar, Sisa_Kewajiban, Status_Sisa_Kewajiban, Tgl_Bayar_Sisa_Kewajiban, AA_Saldo_UP, AA_Saldo_SP, AA_Saldo_SW, AA_Saldo_SS, AA_Saldo_DS, AA_Saldo_SP_Seharusnya, AA_Saldo_SW_Seharusnya, AA_Saldo_DS_Seharusnya, SP_Kurang_Lebih, SW_Kurang_Lebih, DS_Kurang_Lebih, AA_Tgl_Transaksi_AA_Terakhir, AA_Tgl_Transaksi_DS_Terakhir, AA_Print_Line, Created_By, Created_DateTime, Last_Update_By, Last_Update_DateTime, Created_Location, Last_Update_Location, Foto, Besar_Pembagi_Saham', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'No_BA' => 'No Ba',
			'Kelompok' => 'Kelompok',
			'Nama_Sub_Unit_Kelompok' => 'Nama Sub Unit Kelompok',
			...
			'SP_Kurang_Lebih' => 'Sp Kurang Lebih',
			'SW_Kurang_Lebih' => 'Sw Kurang Lebih',
			'DS_Kurang_Lebih' => 'Ds Kurang Lebih',
	...
	public function search()
	{
		...
		$criteria->compare('Nama_Sub_Unit_Kelompok',$this->Nama_Sub_Unit_Kelompok,true);
		...
		$criteria->compare('SP_Kurang_Lebih',$this->SP_Kurang_Lebih,true);
		$criteria->compare('SW_Kurang_Lebih',$this->SW_Kurang_Lebih,true);
		$criteria->compare('DS_Kurang_Lebih',$this->DS_Kurang_Lebih,true);
